...
public class Hw1Switch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case Hw1Package.DOCTOR_APPOINTMENT: {
			DoctorAppointment doctorAppointment = (DoctorAppointment) theEObject;
			T result = caseDoctorAppointment(doctorAppointment);
			if (result == null)
				result = caseAppointment(doctorAppointment);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case Hw1Package.HOSPITAL_APPOINTMENT: {
			HospitalAppointment hospitalAppointment = (HospitalAppointment) theEObject;
			T result = caseHospitalAppointment(hospitalAppointment);
			if (result == null)
				result = caseAppointment(hospitalAppointment);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case Hw1Package.PAYMENT_GATEWAY: {
			PaymentGateway paymentGateway = (PaymentGateway) theEObject;
			T result = casePaymentGateway(paymentGateway);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Doctor Appointment</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Doctor Appointment</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseDoctorAppointment(DoctorAppointment object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Hospital Appointment</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Hospital Appointment</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseHospitalAppointment(HospitalAppointment object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Payment Gateway</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Payment Gateway</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T casePaymentGateway(PaymentGateway object) {
		return null;
	}
